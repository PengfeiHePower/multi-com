...
save_dir = "violations/"+args.dataset+'.json'
checkpoint = "chk_violations/" +args.dataset+'.txt'
...
for i in range(start_index, len(data)):
    ...
    for type_name in prompt_types:
        prompt = prompts[type_name] + "\n\n" + "Question: " + question
        response[type_name] = api_response(system_prompt, prompt)
