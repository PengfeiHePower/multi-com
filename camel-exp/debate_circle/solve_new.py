...
# load dataset
if args.dataset=='mmlubio_correct':
    with open("../../acc_eva/processed_data/mmlubio_correct.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    question_name = 'question'
    answer_name = 'gt'
elif args.dataset=='mmlubio_incorrect':
    with open("../../acc_eva/processed_data/mmlubio_incorrect.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    question_name = 'question'
    answer_name = 'gt'
    ...
    question_name = 'question'
    answer_name = 'gt'
elif args.dataset == 'gsm8k_incorrect':
    with open("../../acc_eva/processed_data/gsm8k_incorrect.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    question_name = 'question'
    answer_name = 'gt'
